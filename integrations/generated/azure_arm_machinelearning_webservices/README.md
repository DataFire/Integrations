...
```bash
npm install --save @datafire/azure_arm_machinelearning_webservices
```
```js
...
* AssetItem `object`: Information about an asset associated with the web service.
  ...
  * locationInfo **required** [AssetLocation](#assetlocation)
...
### AssetLocation
* AssetLocation `object`: Describes the access location for a web service asset.
  ...
  * uri **required** `string`: The URI where the asset is accessible from, (e.g. aml://abc for system assets or https://xyz for user asets
