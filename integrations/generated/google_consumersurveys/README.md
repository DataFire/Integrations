...
let google_consumersurveys = require('@datafire/google_consumersurveys').actions;
...
let context = new datafire.Context({
  accounts: {
    google_consumersurveys: account,
  }
})

google_consumersurveys.surveys.insert({}, context).then(data => {
  console.log(data);
})
```
