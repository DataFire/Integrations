# @datafire/sportsdata_nfl_v3_scores

Client library for NFL v3 Scores

## Installation and Usage
```bash
npm install --save @datafire/sportsdata_nfl_v3_scores
```
```js
let sportsdata_nfl_v3_scores = require('@datafire/sportsdata_nfl_v3_scores').create({
  apiKeyHeader: "",
  apiKeyQuery: ""
});
...
```js
sportsdata_nfl_v3_scores.TeamsAll({
  "format": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.AreGamesInProgress({
  "format": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.ByeWeeks({
  "format": "",
  "season": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.SeasonCurrent({
  "format": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.WeekCurrent({
  "format": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.PlayerDetailsByFreeAgents({
  "format": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.GameStatsBySeasonDeprecatedUseTeamGameStatsInstead({
  "format": "",
  "season": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.GameStatsByWeekDeprecatedUseTeamGameStatsInstead({
  "format": "",
  "season": "",
  "week": ""
}, context)
...
```js
sportsdata_nfl_v3_scores.SeasonLastCompleted({
  "format": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.WeekLastCompleted({
  "format": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.NewsByDate({
  "format": "",
  "date": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.NewsByPlayer({
  "format": "",
  "playerid": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.NewsByTeam({
  "format": "",
  "team": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.XPing({
  "format": "",
  "seconds": ""
}, context)
```
...
* input `object`
  * format **required** `string` (values: XML, JSON): Desired response format. Valid entries are <code>XML</code> or <code>JSON</code>.
  * seconds **required** `string`: Number of seconds to sleep before responding
...
```js
sportsdata_nfl_v3_scores.PlayerDetailsByPlayer({
  "format": "",
  "playerid": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.PlayerDetailsByAvailable({
  "format": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.PlayerDetailsByTeam({
  "format": "",
  "team": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.Referees({
  "format": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.PlayerDetailsByRookieDraftYear({
  "format": "",
  "season": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.Schedule({
  "format": "",
  "season": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.ScoresBySeason({
  "format": "",
  "season": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.ScoresByWeek({
  "format": "",
  "season": "",
  "week": ""
}, context)
...
```js
sportsdata_nfl_v3_scores.ScoresByWeekSimulation({
  "format": "",
  "numberofplays": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.Stadiums({
  "format": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.Standings({
  "format": "",
  "season": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.TeamGameStats({
  "format": "",
  "season": "",
  "week": ""
}, context)
...
```js
sportsdata_nfl_v3_scores.TeamSeasonStats({
  "format": "",
  "season": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.TeamsActive({
  "format": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.TeamsBySeason({
  "format": "",
  "season": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.Timeframes({
  "format": "",
  "type": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.SeasonUpcoming({
  "format": ""
}, context)
```
...
```js
sportsdata_nfl_v3_scores.WeekUpcoming({
  "format": ""
}, context)
```
