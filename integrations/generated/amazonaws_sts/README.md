...
let amazonaws_sts = require('@datafire/amazonaws_sts').actions;
...
let context = new datafire.Context({
  accounts: {
    amazonaws_sts: account,
  }
})


amazonaws_sts.AssumeRole({}, context).then(data => {
  console.log(data);
})
```
...
```js
amazonaws_sts.GetCallerIdentity({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
