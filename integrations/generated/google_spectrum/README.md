...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/PawsGetSpectrumRequest"
    },
    "alt": {
      "type": "string",
...
```json
{
  "$ref": "#/definitions/PawsGetSpectrumResponse"
}
```
## Operation: paws.getSpectrumBatch
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/PawsGetSpectrumBatchRequest"
    },
    "alt": {
      "type": "string",
      "description": "Data format for the response.",
...
```json
{
  "$ref": "#/definitions/PawsGetSpectrumBatchResponse"
}
```
## Operation: paws.init
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/PawsInitRequest"
    },
    "alt": {
      "type": "string",
      "description": "Data format for the response.",
...
```json
{
  "$ref": "#/definitions/PawsInitResponse"
}
```
## Operation: paws.notifySpectrumUse
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/PawsNotifySpectrumUseRequest"
    },
    "alt": {
      "type": "string",
      "description": "Data format for the response.",
...
```json
{
  "$ref": "#/definitions/PawsNotifySpectrumUseResponse"
}
```
## Operation: paws.register
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/PawsRegisterRequest"
    },
    "alt": {
      "type": "string",
      "description": "Data format for the response.",
...
```json
{
  "$ref": "#/definitions/PawsRegisterResponse"
}
```
## Operation: paws.verifyDevice
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/PawsVerifyDeviceRequest"
    },
    "alt": {
      "type": "string",
      "description": "Data format for the response.",
...
```json
{
  "$ref": "#/definitions/PawsVerifyDeviceResponse"
}
```
