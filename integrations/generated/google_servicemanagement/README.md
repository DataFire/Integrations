...
```
## Operation: services.configs.list
...
```json
{
  "$ref": "#/definitions/ListServiceConfigsResponse"
}
```
## Operation: services.configs.create
...
```
## Operation: services.configs.get
Gets a service configuration (version) for a managed service.
...
```
## Operation: services.configs.submit
...
```json
{
  ...
  "properties": {
    ...
    "body": {
      "$ref": "#/definitions/SubmitConfigSourceRequest"
    },
    "upload_protocol": {
      "type": "string",
      "description": "Upload protocol for media (e.g. \"raw\", \"multipart\")."
...
```
## Operation: services.rollouts.list
...
```json
{
  "$ref": "#/definitions/ListServiceRolloutsResponse"
}
```
## Operation: services.rollouts.create
...
```
## Operation: services.rollouts.get
...
```
## Operation: services.generateConfigReport
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/GenerateConfigReportRequest"
    },
    "upload_protocol": {
      "type": "string",
      "description": "Upload protocol for media (e.g. \"raw\", \"multipart\")."
...
```json
{
  "$ref": "#/definitions/GenerateConfigReportResponse"
}
```
...
```
## Operation: services.getIamPolicy
...
```
## Operation: services.setIamPolicy
...
```
## Operation: services.testIamPermissions
