...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/AddInstanceFleetInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/AddInstanceFleetOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/AddInstanceGroupsInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/AddInstanceGroupsOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/AddJobFlowStepsInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/AddJobFlowStepsOutput"
}
```
## Operation: AddTags
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/CancelStepsInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/CancelStepsOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/CreateSecurityConfigurationInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/CreateSecurityConfigurationOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/DeleteSecurityConfigurationInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/DeleteSecurityConfigurationOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/DescribeClusterInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/DescribeClusterOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/DescribeJobFlowsInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/DescribeJobFlowsOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/DescribeSecurityConfigurationInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/DescribeSecurityConfigurationOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/DescribeStepInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/DescribeStepOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/ListBootstrapActionsInput"
    },
    "Marker": {
      "type": "string",
...
```json
{
  "$ref": "#/definitions/ListBootstrapActionsOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/ListClustersInput"
    },
    "Marker": {
      "type": "string",
      "description": "Pagination token"
...
```json
{
  "$ref": "#/definitions/ListClustersOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/ListInstanceFleetsInput"
    },
    "Marker": {
      "type": "string",
      "description": "Pagination token"
...
```json
{
  "$ref": "#/definitions/ListInstanceFleetsOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/ListInstanceGroupsInput"
    },
    "Marker": {
      "type": "string",
      "description": "Pagination token"
...
```json
{
  "$ref": "#/definitions/ListInstanceGroupsOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/ListInstancesInput"
    },
    "Marker": {
      "type": "string",
      "description": "Pagination token"
...
```json
{
  "$ref": "#/definitions/ListInstancesOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/ListSecurityConfigurationsInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/ListSecurityConfigurationsOutput"
}
```
## Operation: ListSteps
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/ListStepsInput"
    },
    "Marker": {
      "type": "string",
      "description": "Pagination token"
...
```json
{
  "$ref": "#/definitions/ListStepsOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/ModifyInstanceFleetInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/ModifyInstanceGroupsInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/PutAutoScalingPolicyInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/PutAutoScalingPolicyOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/RemoveAutoScalingPolicyInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/RemoveAutoScalingPolicyOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/RunJobFlowInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/RunJobFlowOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/SetTerminationProtectionInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/SetVisibleToAllUsersInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/TerminateJobFlowsInput"
    },
    "Action": {
      "type": "string"
    },
