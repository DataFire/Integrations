...
```bash
npm install --save datafire @datafire/clarify
```
...
#### Parameters
* bundle_id (string) **required** - id of a bundle
* insight (string) **required** - name of the insight: transcript_r9, captions_r9, spoken_keywords, spoken_topics, spoken_words
...
#### Parameters
* bundle_id (string) **required** - id of a bundle
* insight_id (string) **required** - id of an insight
...
#### Parameters
* bundle_id (string) **required** - id of a bundle
* data (string) **required** - User-defined JSON data associated with the bundle. Must be valid JSON, up to 4000 characters.
* version (integer) - Object version.
...
* media_url (string) **required** - URL of a media file for this bundle. Up to 2083 characters.
* audio_channel (string) - The audio channel to use for the track ( "" | left | right ). Default is empty string which means all channels of audio in the media file are used for the track.
* audio_language (string) - Language of the audio in the track, specified with an RFC5646 code.
* start_time (number) - Time offset in seconds that the media starts relative to the bundle. Default is 0.
* parts_pending (boolean) - Set to true if more media parts will be added to the track. Default is false.
...
#### Parameters
* bundle_id (string) **required** - id of a bundle
* parts_complete (boolean) **required** - Set to true if media parts in all tracks are complete. Default is false.
* version (integer) - Object version.
...
#### Parameters
* bundle_id (string) **required** - id of a bundle
* track_id (string) **required** - id of a track
