...
```
## Operation: agentActivities.list
...
```
## Operation: agentActivities.create
...
```
## Operation: agentActivities.createFromHelpCenterDeepLink
...
```
## Operation: cases.getAgentUnreadCasesInfo
...
```
## Operation: cases.getAgentSearchCount
...
```
## Operation: cases.validateConsultForm
...
```
## Operation: categoryInfos.batchGet
...
```
## Operation: categoryInfos.listTopLevel
...
```
## Operation: categoryInfos.search
...
```
## Operation: categoryInfos.searchMultiple
...
```
## Operation: communications.buildNewEmail
...
```
## Operation: communications.buildReplyEmail
...
```
## Operation: communications.createConsultNote
...
```
## Operation: communications.createEmail
...
```
## Operation: communications.createNote
Creates a note.
...
```
## Operation: communications.listRelated
...
```
## Operation: communications.suggestReplyEmailHeaders
...
```
## Operation: customerInteractions.list
...
```
## Operation: customerInteractions.summarize
...
```
## Operation: giftCards.checkRedeemer
...
```
## Operation: ginlogs.logDataAccess
Logs data access.
...
```
## Operation: hardwareAuditor.orders.list
...
```
## Operation: hardwareOrders.hardwareSignals
...
```
## Operation: hardwareOrders.listOtherDevices
...
```
## Operation: opportunities.pitches.batchCreate
...
```
## Operation: play.digitalContent.orders.batchGet
...
```
## Operation: play.digitalContent.orders.refund
Refund orders.
...
```
## Operation: play.digitalContent.orders.search
Search for orders.
...
```
## Operation: play.digitalContent.subscriptions.batchGet
...
```
## Operation: play.digitalContent.subscriptions.cancel
Cancel subscription.
...
```
## Operation: play.digitalContent.subscriptions.getCancellationStatus
...
```
## Operation: play.digitalContent.subscriptions.list
List subscriptions.
...
```
## Operation: play.digitalContent.getRefundStatus
Get refund status.
...
```
## Operation: resolutions.cohorts.assign
...
```
## Operation: rmas.createExchangeWithoutReturn
...
```
## Operation: rmas.listBuyersRemorseCountryCodes
...
```
## Operation: teams.getMyAssignStreamSearches
...
```
## Operation: troubleshooterSessions.create
...
```
## Operation: troubleshooterSessions.listDevices
...
```
## Operation: troubleshooterSessions.listIssues
Lists issues.
...
```
## Operation: troubleshooterSessions.listPurchasedApps
...
```
## Operation: troubleshooterSessions.listPurchasedBooks
...
```
## Operation: troubleshooterSessions.listPurchasedVideos
...
```
## Operation: wallets.accounts.paymentInstruments.getHijackReviewsStatus
...
```
## Operation: wallets.accounts.paymentInstruments.initiateHijackReviews
...
```
## Operation: wallets.accounts.getPaymentsInfo
...
```
## Operation: wallets.accounts.getReviewStatus
...
```
## Operation: wallets.accounts.getSignals
...
```
## Operation: wallets.accounts.searchReviews
...
```
## Operation: wallets.bankAccountCountries
...
```
## Operation: wallets.creditCardTypes
...
```
## Operation: wallets.paymentInstrumentTypeInfos.list
...
```
## Operation: wallets.paymentInstruments.suggestIssuer
...
```
## Operation: wallets.transactions
...
```
## Operation: wallets.troubleshootAccount
...
```
## Operation: wallets.troubleshootTransaction
...
```
## Operation: youtube.components.cancel
...
```
## Operation: youtube.entitlements.cancel
Cancel entitlement.
...
```
## Operation: youtube.onetimepurchases
...
```
## Operation: youtube.transactions.listByEntitlements
...
```
## Operation: youtube.transactions.refund
...
```
## Operation: communications.attachments.delete
...
```
## Operation: cases.workflows.post
...
```
## Operation: cases.issue.updateProduct
...
```
## Operation: cases.customer.billingAddresses
...
```
## Operation: cases.customer.shippingAddresses
...
```
## Operation: categoryInfos.properties.list
...
```
## Operation: hardwareShipments.refunds
...
```
## Operation: cases.waitForConsult
...
```
## Operation: cases.customer.authenticate
...
```
## Operation: cases.attributes.batchUpdate
...
```
## Operation: communications.cancelSend
...
```
## Operation: cases.customer.checkWalletAccount
...
```
## Operation: cases.createNoteConsult
...
```
## Operation: cases.createRealTimeConsult
...
```
## Operation: cases.customer.deauthenticate
...
```
## Operation: communications.discardDraft
...
```
## Operation: communications.finalizeConsultNote
...
```
## Operation: communications.finalizeNote
...
```
## Operation: cases.customer.getAuthenticationCreditCardTypes
...
```
## Operation: cases.customer.getAuthenticationQuestions
...
```
## Operation: cases.customer.getAuthenticationResult
...
```
## Operation: cases.customer.getBusinessListings
...
```
## Operation: hardwareOrders.getDetail
...
```
## Operation: products.getEscalationTargets
...
```
## Operation: rmas.getLostStolenEligibility
...
```
## Operation: hardwareShipments.getLostStolenRefundEligibility
...
```
## Operation: rmas.getMailingAddress
...
```
## Operation: rmas.getReplacementDetail
...
```
## Operation: products.getRoutingTargets
...
```
## Operation: hardwareShipments.getShippingAddress
...
```
## Operation: hardwareShipments.getShippingCustomerName
...
```
## Operation: hardwareShipments.getShippingCustomerPhoneNumber
...
```
## Operation: categoryInfos.listChildren
...
```
## Operation: products.listSettings
...
```
## Operation: troubleshooterSessions.log
...
```
## Operation: rmas.markOriginalDeviceReceived
...
```
## Operation: cases.offeredSolution
...
```
## Operation: hardwareShipments.refund
...
```
## Operation: cases.suggestNewEmailHeaders
...
```
## Operation: cases.suggestNoteHeaders
...
```
## Operation: troubleshooterSessions.troubleshootIssue
Troubleshoot issue.
...
```
## Operation: cases.attributes.update
...
```
## Operation: cases.workflows.update
...
```
## Operation: cases.issue.product.updateAgentCategories
...
```
## Operation: communications.updateConsultNote
...
```
## Operation: cases.customer.updateContactEmail
...
```
## Operation: cases.customer.updateContactName
...
```
## Operation: cases.customer.updateCustomerAttributes
...
```
## Operation: cases.updateDisconnectedChannel
...
```
## Operation: cases.updateEligibleProgram
...
```
## Operation: communications.updateEmail
...
```
## Operation: cases.issue.updateLocale
...
```
## Operation: communications.updateNote
...
```
## Operation: cases.issue.updateSummary
