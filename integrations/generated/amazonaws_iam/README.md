...
```js
amazonaws_iam.DeleteAccountPasswordPolicy({
  "Action": "",
  "Version": ""
}, context)
```
...
```js
amazonaws_iam.GenerateCredentialReport({
  "Action": "",
  "Version": ""
}, context)
```
...
```js
amazonaws_iam.GetAccountAuthorizationDetails({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_iam.GetAccountPasswordPolicy({
  "Action": "",
  "Version": ""
}, context)
```
...
```js
amazonaws_iam.GetAccountSummary({
  "Action": "",
  "Version": ""
}, context)
```
...
```js
amazonaws_iam.GetCredentialReport({
  "Action": "",
  "Version": ""
}, context)
```
...
```js
amazonaws_iam.ListAccountAliases({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_iam.ListInstanceProfiles({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_iam.ListOpenIDConnectProviders({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_iam.ListSAMLProviders({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_iam.ListSSHPublicKeys({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_iam.ListServerCertificates({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_iam.ListServiceSpecificCredentials({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_iam.ListSigningCertificates({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_iam.ListVirtualMFADevices({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_iam.UpdateAccountPasswordPolicy({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
