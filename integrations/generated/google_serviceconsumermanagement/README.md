...
Client library for Service Consumer Management
...
```js
google_serviceconsumermanagement.operations.get({
  "name": ""
}, context)
```
...
```js
google_serviceconsumermanagement.operations.cancel({
  "name": ""
}, context)
```
...
```js
google_serviceconsumermanagement.services.tenancyUnits.removeProject({
  "name": ""
}, context)
```
...
#### Input
* input `object`
  * body [RemoveTenantProjectRequest](#removetenantprojectrequest)
  * name **required** `string`: Name of the tenancy unit.
  * $.xgafv `string` (values: 1, 2): V1 error format.
  * access_token `string`: OAuth access token.
  * alt `string` (values: json, media, proto): Data format for response.
  * bearer_token `string`: OAuth bearer token.
...
```js
google_serviceconsumermanagement.services.tenancyUnits.list({
  "parent": ""
}, context)
```
...
* input `object`
  ...
  * parent **required** `string`: Service and consumer. Required.
  * $.xgafv `string` (values: 1, 2): V1 error format.
  * access_token `string`: OAuth access token.
  * alt `string` (values: json, media, proto): Data format for response.
  * bearer_token `string`: OAuth bearer token.
...
#### Output
* output [ListTenancyUnitsResponse](#listtenancyunitsresponse)
...
```js
google_serviceconsumermanagement.services.tenancyUnits.create({
  "parent": ""
}, context)
```
...
#### Input
* input `object`
  * body [CreateTenancyUnitRequest](#createtenancyunitrequest)
  * parent **required** `string`: services/{service}/{collection id}/{resource id}
  * $.xgafv `string` (values: 1, 2): V1 error format.
  * access_token `string`: OAuth access token.
  * alt `string` (values: json, media, proto): Data format for response.
  * bearer_token `string`: OAuth bearer token.
...
#### Output
* output [TenancyUnit](#tenancyunit)
...
```js
google_serviceconsumermanagement.services.tenancyUnits.addProject({
  "parent": ""
}, context)
```
...
#### Input
* input `object`
  * body [AddTenantProjectRequest](#addtenantprojectrequest)
  * parent **required** `string`: Name of the tenancy unit.
  * $.xgafv `string` (values: 1, 2): V1 error format.
  * access_token `string`: OAuth access token.
  * alt `string` (values: json, media, proto): Data format for response.
  * bearer_token `string`: OAuth bearer token.
...
```js
google_serviceconsumermanagement.services.search({
  "parent": ""
}, context)
```
...
* input `object`
  ...
  * pageToken `string`: The continuation token, which is used to page through large result sets.
  * parent **required** `string`: Service for which search is performed.
...
#### Output
* output [SearchTenancyUnitsResponse](#searchtenancyunitsresponse)
...
### PolicyBinding
* PolicyBinding `object`: Translates to IAM Policy bindings (without auditing at this level)
  * members `array`: Uses the same format as in IAM policy.
    * items `string`
  * role `string`: Role. (https://cloud.google.com/iam/docs/understanding-roles)
...
* RemoveTenantProjectRequest `object`: Request message to remove tenant project resource from the tenancy unit.
  * tag `string`: Tag of the resource within the tenancy unit.

### SearchTenancyUnitsResponse
* SearchTenancyUnitsResponse `object`: Response for the search query.
  * nextPageToken `string`: Pagination token for large results.
  * tenancyUnits `array`: Tenancy Units matching the request.
    * items [TenancyUnit](#tenancyunit)
...
* TenancyUnit `object`: Representation of a tenancy unit.
  ...
  * tenantResources `array`: Resources constituting the tenancy unit.
    * items [TenantResource](#tenantresource)

### TenantProjectConfig
* TenantProjectConfig `object`: This structure defines a tenant project to be added to the specified tenancy
  * billingConfig [BillingConfig](#billingconfig)
  * folder `string`: Folder where project in this tenancy unit must be located
  * labels `object`: Labels that will be applied to this project.
  * serviceAccountConfig [ServiceAccountConfig](#serviceaccountconfig)
  * services `array`: Google Cloud API names of services that will be activated on this project
    * items `string`
  * tenantProjectPolicy [TenantProjectPolicy](#tenantprojectpolicy)
...
### TenantResource
* TenantResource `object`: Resource constituting the TenancyUnit.
  * resource `string`: @OutputOnly Identifier of the tenant resource.
  * status `string` (values: STATUS_UNSPECIFIED, PENDING_CREATE, ACTIVE, PENDING_DELETE, FAILED): Status of tenant resource.
