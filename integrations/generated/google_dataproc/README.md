...
```
## Operation: projects.regions.clusters.list
...
```
## Operation: projects.regions.clusters.create
...
```
## Operation: projects.regions.clusters.delete
...
```
## Operation: projects.regions.clusters.get
...
```
## Operation: projects.regions.clusters.patch
...
```
## Operation: projects.regions.clusters.diagnose
...
```
## Operation: projects.regions.jobs.list
...
```
## Operation: projects.regions.jobs.delete
...
```
## Operation: projects.regions.jobs.get
...
```
## Operation: projects.regions.jobs.patch
...
```
## Operation: projects.regions.jobs.cancel
...
```
## Operation: projects.regions.jobs.submit
...
```
## Operation: projects.regions.operations.delete
...
```
## Operation: projects.regions.operations.get
...
```
## Operation: projects.regions.operations.cancel
