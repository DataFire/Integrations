...
```js
amazonaws_opsworks.DescribeAgentVersions({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_opsworks.DescribeApps({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_opsworks.DescribeCommands({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_opsworks.DescribeDeployments({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_opsworks.DescribeEcsClusters({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_opsworks.DescribeElasticIps({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_opsworks.DescribeElasticLoadBalancers({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_opsworks.DescribeInstances({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_opsworks.DescribeLayers({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_opsworks.DescribeMyUserProfile({
  "Action": "",
  "Version": ""
}, context)
```
...
```js
amazonaws_opsworks.DescribePermissions({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_opsworks.DescribeRaidArrays({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_opsworks.DescribeServiceErrors({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_opsworks.DescribeStacks({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_opsworks.DescribeUserProfiles({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_opsworks.DescribeVolumes({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_opsworks.UpdateMyUserProfile({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
