# @datafire/sportsdata_mlb_v3_stats

Client library for MLB v3 Stats

## Installation and Usage
```bash
npm install --save @datafire/sportsdata_mlb_v3_stats
```
```js
let sportsdata_mlb_v3_stats = require('@datafire/sportsdata_mlb_v3_stats').create({
  apiKeyHeader: "",
  apiKeyQuery: ""
});
...
```js
sportsdata_mlb_v3_stats.TeamsAll({
  "format": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.AreGamesInProgress({
  "format": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.BoxScore({
  "format": "",
  "gameid": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.BoxScoresByDate({
  "format": "",
  "date": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.BoxScoresByDateDelta({
  "format": "",
  "date": "",
  "minutes": ""
}, context)
...
```js
sportsdata_mlb_v3_stats.CurrentSeason({
  "format": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.DfsSlatesByDate({
  "format": "",
  "date": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.PlayerDetailsByFreeAgents({
  "format": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.Schedules({
  "format": "",
  "season": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.GamesByDate({
  "format": "",
  "date": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.BatterVsPitcherStats({
  "format": "",
  "hitterid": "",
  "pitcherid": ""
}, context)
...
```js
sportsdata_mlb_v3_stats.NewsByDate({
  "format": "",
  "date": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.NewsByPlayer({
  "format": "",
  "playerid": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.PlayerDetailsByPlayer({
  "format": "",
  "playerid": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.PlayerGameStatsByDate({
  "format": "",
  "date": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.PlayerGameStatsByPlayer({
  "format": "",
  "date": "",
  "playerid": ""
}, context)
...
```js
sportsdata_mlb_v3_stats.PlayerGameLogsBySeason({
  "format": "",
  "season": "",
  "playerid": "",
  "numberofgames": ""
...
```js
sportsdata_mlb_v3_stats.PlayerSeasonAwayStats({
  "format": "",
  "season": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.PlayerSeasonHomeStats({
  "format": "",
  "season": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.PlayerSeasonSplitStats({
  "format": "",
  "season": "",
  "split": ""
}, context)
...
```js
sportsdata_mlb_v3_stats.PlayerSeasonStats({
  "format": "",
  "season": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.PlayerSeasonStatsByPlayer({
  "format": "",
  "season": "",
  "playerid": ""
}, context)
...
```js
sportsdata_mlb_v3_stats.PlayerSeasonStatsByTeam({
  "format": "",
  "season": "",
  "team": ""
}, context)
...
```js
sportsdata_mlb_v3_stats.PlayerSeasonStatsSplitByTeam({
  "format": "",
  "season": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.PlayerDetailsByActive({
  "format": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.PlayersByTeam({
  "format": "",
  "team": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.Stadiums({
  "format": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.Standings({
  "format": "",
  "season": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.TeamGameStatsByDate({
  "format": "",
  "date": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.TeamHittingVsStartingPitcher({
  "format": "",
  "gameid": "",
  "team": ""
}, context)
...
```js
sportsdata_mlb_v3_stats.TeamSeasonStats({
  "format": "",
  "season": ""
}, context)
```
...
```js
sportsdata_mlb_v3_stats.TeamsActive({
  "format": ""
}, context)
```
