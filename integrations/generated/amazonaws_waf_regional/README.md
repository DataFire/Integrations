...
let context = new datafire.Context({
  accounts: {
    amazonaws_waf_regional: account,
  }
})
...
```js
amazonaws_waf_regional.GetChangeToken({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_waf_regional.ListByteMatchSets({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_waf_regional.ListIPSets({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_waf_regional.ListRules({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_waf_regional.ListSizeConstraintSets({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_waf_regional.ListSqlInjectionMatchSets({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_waf_regional.ListWebACLs({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_waf_regional.ListXssMatchSets({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
