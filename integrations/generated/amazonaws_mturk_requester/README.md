...
let context = new datafire.Context({
  accounts: {
    amazonaws_mturk_requester: account,
  }
})
...
```js
amazonaws_mturk_requester.GetAccountBalance({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_mturk_requester.ListBonusPayments({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_mturk_requester.ListHITs({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_mturk_requester.ListQualificationRequests({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_mturk_requester.ListReviewableHITs({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_mturk_requester.ListWorkerBlocks({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
