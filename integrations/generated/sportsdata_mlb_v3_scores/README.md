# @datafire/sportsdata_mlb_v3_scores

Client library for MLB v3 Scores

## Installation and Usage
```bash
npm install --save @datafire/sportsdata_mlb_v3_scores
```
```js
let sportsdata_mlb_v3_scores = require('@datafire/sportsdata_mlb_v3_scores').create({
  apiKeyHeader: "",
  apiKeyQuery: ""
});
...
```js
sportsdata_mlb_v3_scores.TeamsAll({
  "format": ""
}, context)
```
...
```js
sportsdata_mlb_v3_scores.AreGamesInProgress({
  "format": ""
}, context)
```
...
```js
sportsdata_mlb_v3_scores.CurrentSeason({
  "format": ""
}, context)
```
...
```js
sportsdata_mlb_v3_scores.PlayerDetailsByFreeAgents({
  "format": ""
}, context)
```
...
```js
sportsdata_mlb_v3_scores.Schedules({
  "format": "",
  "season": ""
}, context)
```
...
```js
sportsdata_mlb_v3_scores.GamesByDate({
  "format": "",
  "date": ""
}, context)
```
...
```js
sportsdata_mlb_v3_scores.NewsByDate({
  "format": "",
  "date": ""
}, context)
```
...
```js
sportsdata_mlb_v3_scores.NewsByPlayer({
  "format": "",
  "playerid": ""
}, context)
```
...
```js
sportsdata_mlb_v3_scores.PlayerDetailsByPlayer({
  "format": "",
  "playerid": ""
}, context)
```
...
```js
sportsdata_mlb_v3_scores.PlayerDetailsByActive({
  "format": ""
}, context)
```
...
```js
sportsdata_mlb_v3_scores.PlayersByTeam({
  "format": "",
  "team": ""
}, context)
```
...
```js
sportsdata_mlb_v3_scores.Stadiums({
  "format": ""
}, context)
```
...
```js
sportsdata_mlb_v3_scores.Standings({
  "format": "",
  "season": ""
}, context)
```
...
```js
sportsdata_mlb_v3_scores.TeamGameStatsByDate({
  "format": "",
  "date": ""
}, context)
```
...
```js
sportsdata_mlb_v3_scores.TeamSeasonStats({
  "format": "",
  "season": ""
}, context)
```
...
```js
sportsdata_mlb_v3_scores.TeamsActive({
  "format": ""
}, context)
```
