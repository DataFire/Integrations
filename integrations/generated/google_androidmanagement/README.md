...
```bash
npm install --save datafire @datafire/google_androidmanagement
```
...
#### Parameters
* body (object) - The configuration applied to an enterprise.
...
#### Parameters
* body (object) - A device owned by an enterprise. Unless otherwise noted, all fields are read-only and cannot be modified by an update device request.
...
#### Parameters
* body (object) - An enrollment token.
* parent (string) **required** - The name of the enterprise in the form enterprises/{enterpriseId}
* $.xgafv (string) - V1 error format.
* access_token (string) - OAuth access token.
* alt (string) - Data format for response.
...
#### Parameters
* body (object) - A web token used to access an embeddable managed Google Play web UI.
* parent (string) **required** - The name of the enterprise in the form enterprises/{enterpriseId}
* $.xgafv (string) - V1 error format.
* access_token (string) - OAuth access token.
* alt (string) - Data format for response.
