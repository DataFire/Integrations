...
let azure_arm_mediaservices = require('@datafire/azure_arm_mediaservices').actions;
...
let context = new datafire.Context({
  accounts: {
    azure_arm_mediaservices: account,
  }
})


azure_arm_mediaservices.MediaService_CheckNameAvailability({}, context).then(data => {
  console.log(data);
})
```
