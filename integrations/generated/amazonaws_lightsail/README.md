...
```js
amazonaws_lightsail.DownloadDefaultKeyPair({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_lightsail.GetActiveNames({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_lightsail.GetBlueprints({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_lightsail.GetBundles({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_lightsail.GetDomains({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_lightsail.GetInstanceSnapshots({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_lightsail.GetInstances({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_lightsail.GetKeyPairs({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_lightsail.GetOperations({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_lightsail.GetRegions({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_lightsail.GetStaticIps({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_lightsail.IsVpcPeered({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
