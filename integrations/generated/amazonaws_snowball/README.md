...
```js
amazonaws_snowball.DescribeAddresses({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_snowball.GetSnowballUsage({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_snowball.ListClusters({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
