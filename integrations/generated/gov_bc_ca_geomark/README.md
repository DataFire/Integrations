...
{}
```
## Operation: geomarks.geomarkId.fileFormatExtension.get
...
{}
```
## Operation: geomarks.geomarkId.boundingBox.fileFormatExtension.get
The source geomarks can be specified by with the geomarkUrl parameter.  Repeat the parameter if sourcing from multiple geomarks
...
{}
```
## Operation: geomarks.geomarkId.feature.fileFormatExtension.get
...
{}
```
## Operation: geomarks.geomarkId.parts.fileFormatExtension.get
...
{}
```
## Operation: geomarks.geomarkId.point.fileFormatExtension.get
