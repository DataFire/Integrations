...
```bash
npm install --save datafire @datafire/picasa
```
...
#### Parameters
* GData-Version (string) **required** - The API version. Current version is 2.
* userID (string) **required** - The Picasa User ID. The string "default" can be used in place of a real user ID, in which case the ID of the user whose credentials authenticated the request is used.
* kind (string) - Picasa Web Albums-specific query parameter for kind queries.
* access (string) - Visibility parameter.
* alt (string) - Alternative representation type. If you don't specify an alt parameter, the service returns an Atom feed. This is equivalent to alt=atom.
...
* userID (string) **required** - The Picasa User ID. The string "default" can be used in place of a real user ID, in which case the ID of the user whose credentials authenticated the request is used.
* albumID (string) **required** - The album ID.
* photoID (string) **required** - The photo ID.
* kind (string) - Picasa Web Albums-specific query parameter for kind queries.
* access (string) - Visibility parameter.
* alt (string) - Alternative representation type. If you don't specify an alt parameter, the service returns an Atom feed. This is equivalent to alt=atom.
* bbox (string) - Bounding-box search of geo coordinates. Searches for data in the specified bounding box. The coordinates should be in the following order: west, south, east, north.
