...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/ChangeMessageVisibilityBatchRequest"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/ChangeMessageVisibilityBatchResult"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/DeleteMessageBatchRequest"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/DeleteMessageBatchResult"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/DeleteQueueRequest"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/GetQueueUrlRequest"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/ListDeadLetterSourceQueuesRequest"
    },
    "Action": {
      "type": "string"
    },
...
Returns a list of your queues. The maximum number of queues that can be returned is 1,000. If you specify a value for the optional <code>QueueNamePrefix</code> parameter, only queues with a name that begins with the specified value are returned.
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/ListQueuesRequest"
    },
    "Action": {
      "type": "string"
    },
...
Revokes any permissions in the queue policy that matches the specified <code>Label</code> parameter. Only the owner of the queue can remove permissions.
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/SendMessageBatchRequest"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/SendMessageBatchResult"
}
```
