...
## Operation: echo_rest_services.get_download.get
...
```
## Operation: echo_rest_services.get_facilities.get
...
```json
{
  ...
  "properties": {
    ...
    "p_sid": {
      "type": "string",
      "description": "System Identifier.  The unique facility identifer for the EPA system.  Examples:  For ICIS NPDES the 9 digit NPDES Id."
    },
    "p_frs": {
      "type": "string",
    ...
    "p_feac": {
      "type": "string",
      "description": "Formal Enforcment Action Last Case Date Limiter Flag.  Enter a value of \"Y\" to additionally apply the p_feay year filter to the last formal enforcement action case date.  Use the p_fea parameter to control if the filter is within or outside the date span provided."
    },
    "p_iea": {
      "type": "string",
...
```
## Operation: echo_rest_services.get_facility_info.get
...
```
## Operation: echo_rest_services.get_geojson.get
...
```json
{
  "$ref": "#/definitions/ers5_FeatureCollection"
}
```
## Operation: echo_rest_services.get_info_clusters.get
...
```
## Operation: echo_rest_services.get_map.get
...
```json
{
  ...
  "properties": {
    "MapOutput": {
      "$ref": "#/definitions/ers0_MapOutput"
    }
  },
  "required": [
    "MapOutput"
...
```
## Operation: echo_rest_services.get_qid.get
...
```
## Operation: echo_rest_services.metadata.get
