...
let context = new datafire.Context({
  accounts: {
    amazonaws_cloudformation: account,
  }
})
...
#### Parameters
* body (object) **required** - The input for the <a>CancelUpdateStack</a> action.
...
#### Parameters
* body (object) **required** - The input for the <a>ContinueUpdateRollback</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - The input for the <a>CreateChangeSet</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - The input for <a>CreateStack</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - The input for the <a>DeleteChangeSet</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - The input for <a>DeleteStack</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
```js
amazonaws_cloudformation.DescribeAccountLimits({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
#### Parameters
* body (object) **required** - The input for the <a>DescribeAccountLimits</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - The input for the <a>DescribeChangeSet</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
```js
amazonaws_cloudformation.DescribeStackEvents({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
#### Parameters
* body (object) **required** - The input for <a>DescribeStackEvents</a> action.
...
#### Parameters
* body (object) **required** - The input for <a>DescribeStackResource</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
```js
amazonaws_cloudformation.DescribeStackResources({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
#### Parameters
* body (object) **required** - The input for <a>DescribeStackResources</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
```js
amazonaws_cloudformation.DescribeStacks({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
#### Parameters
* body (object) **required** - The input for <a>DescribeStacks</a> action.
* NextToken (string) - Pagination token
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
...
```js
amazonaws_cloudformation.EstimateTemplateCost({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
#### Parameters
* body (object) **required** - The input for an <a>EstimateTemplateCost</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - The input for the <a>ExecuteChangeSet</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - The input for the <a>GetStackPolicy</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
```js
amazonaws_cloudformation.GetTemplate({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
#### Parameters
* body (object) **required** - The input for a <a>GetTemplate</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
```js
amazonaws_cloudformation.GetTemplateSummary({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
#### Parameters
* body (object) **required** - The input for the <a>GetTemplateSummary</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - The input for the <a>ListChangeSets</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
```js
amazonaws_cloudformation.ListExports({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
#### Parameters
* body (object) **required** - The input for the <a>ListStackResource</a> action.
* NextToken (string) - Pagination token
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
...
```js
amazonaws_cloudformation.ListStacks({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
#### Parameters
* body (object) **required** - The input for <a>ListStacks</a> action.
* NextToken (string) - Pagination token
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
...
#### Parameters
* body (object) **required** - The input for the <a>SetStackPolicy</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - The input for the <a>SignalResource</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - The input for an <a>UpdateStack</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
```js
amazonaws_cloudformation.ValidateTemplate({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
#### Parameters
* body (object) **required** - The input for <a>ValidateTemplate</a> action.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
