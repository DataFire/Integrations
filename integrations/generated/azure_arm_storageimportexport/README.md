...
let azure_arm_storageimportexport = require('@datafire/azure_arm_storageimportexport').actions;
...
let context = new datafire.Context({
  accounts: {
    azure_arm_storageimportexport: account,
  }
})


azure_arm_storageimportexport.ListLocations({}, context).then(data => {
  console.log(data);
})
```
