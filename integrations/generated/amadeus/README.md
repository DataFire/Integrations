...
## Operation: airports.autocomplete.get
...
```
## Operation: airports.nearest_relevant.get
...
```
## Operation: cars.search_airport.get
...
```
## Operation: cars.search_circle.get
...
```
## Operation: flights.affiliate_search.get
...
```
## Operation: flights.extensive_search.get
...
```
## Operation: flights.inspiration_search.get
...
```
## Operation: flights.low_fare_search.get
...
```
## Operation: hotels.search_airport.get
...
```json
{
  ...
  "properties": {
    ...
    "amenity": {
      "type": "array",
      "description": "Hotel <a href=\"hotels-api-supported-amenities-filter\">amenities filter</a> to search narrow down hotels with certain amenities. For example&colon; amenity=POOL. (Note: multiple amenities can be used in searches: amenity=PARKING&amenity=RESTAURANT&amenity=PETS_ALLOWED).\n"
    }
  },
  "additionalProperties": false,
  "required": [
...
```
## Operation: hotels.search_box.get
...
```
## Operation: hotels.search_circle.get
...
```
## Operation: hotels.property_code.get
...
```
## Operation: points_of_interest.yapq_search_circle.get
...
```
## Operation: points_of_interest.yapq_search_text.get
...
```
## Operation: rail_stations.autocomplete.get
...
```
## Operation: trains.extensive_search.get
...
```
## Operation: trains.schedule_search.get
...
```
## Operation: travel_intelligence.flight_traffic.get
...
```
## Operation: travel_intelligence.top_destinations.get
...
```
## Operation: travel_intelligence.top_searches.get
...
```
## Operation: travel_record.record_locator.get
