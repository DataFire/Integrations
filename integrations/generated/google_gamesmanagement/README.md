...
```
## Operation: achievements.resetAll
...
```json
{
  "$ref": "#/definitions/AchievementResetAllResponse"
}
```
## Operation: achievements.resetAllForAllPlayers
...
{}
```
## Operation: achievements.resetMultipleForAllPlayers
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/AchievementResetMultipleForAllRequest"
    },
    "alt": {
      "type": "string",
      "description": "Data format for the response.",
...
```json
{
  "$ref": "#/definitions/AchievementResetResponse"
}
```
## Operation: achievements.resetForAllPlayers
...
{}
```
## Operation: applications.listHidden
...
```json
{
  "$ref": "#/definitions/HiddenPlayerList"
}
```
## Operation: players.unhide
...
{}
```
## Operation: events.resetAllForAllPlayers
...
{}
```
## Operation: events.resetMultipleForAllPlayers
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/EventsResetMultipleForAllRequest"
    },
    "alt": {
      "type": "string",
      "description": "Data format for the response.",
...
{}
```
## Operation: events.resetForAllPlayers
...
```json
{
  "$ref": "#/definitions/PlayerScoreResetResponse"
}
```
## Operation: scores.resetForAllPlayers
...
{}
```
## Operation: quests.resetAllForAllPlayers
...
{}
```
## Operation: quests.resetMultipleForAllPlayers
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/QuestsResetMultipleForAllRequest"
    },
    "alt": {
      "type": "string",
      "description": "Data format for the response.",
...
{}
```
## Operation: quests.resetForAllPlayers
...
{}
```
## Operation: rooms.resetForAllPlayers
...
```json
{
  "$ref": "#/definitions/PlayerScoreResetAllResponse"
}
```
## Operation: scores.resetAllForAllPlayers
...
{}
```
## Operation: scores.resetMultipleForAllPlayers
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/ScoresResetMultipleForAllRequest"
    },
    "alt": {
      "type": "string",
      "description": "Data format for the response.",
...
{}
```
## Operation: turnBasedMatches.reset
...
{}
```
## Operation: turnBasedMatches.resetForAllPlayers
