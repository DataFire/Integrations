...
```json
{
  "$ref": "#/definitions/SearchServicesResponse"
}
```
## Operation: projects.services.disable
...
```
## Operation: projects.services.enable
...
```
## Operation: projects.services.list
...
```json
{
  "$ref": "#/definitions/ListEnabledServicesResponse"
}
```
