...
#### Parameters
* body (object) **required** - Represents the input of a <code>BatchGetItem</code> operation.
...
#### Parameters
* body (object) **required** - Represents the input of a <code>BatchWriteItem</code> operation.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - Represents the input of a <code>CreateTable</code> operation.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - Represents the input of a <code>DeleteItem</code> operation.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - Represents the input of a <code>DeleteTable</code> operation.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
```js
amazonaws_dynamodb.DescribeLimits({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
#### Parameters
* body (object) **required** - Represents the input of a <code>DescribeLimits</code> operation. Has no content.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - Represents the input of a <code>DescribeTable</code> operation.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - Represents the input of a <code>GetItem</code> operation.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - Represents the input of a <code>ListTables</code> operation.
...
#### Parameters
* body (object) **required** - Represents the input of a <code>PutItem</code> operation.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - Represents the input of a <code>Query</code> operation.
* Limit (string) - Pagination limit
...
#### Parameters
* body (object) **required** - Represents the input of a <code>Scan</code> operation.
* Limit (string) - Pagination limit
* ExclusiveStartKey (string) - Pagination token
* Action (string) **required**
* Version (string) **required**
...
#### Parameters
* body (object) **required** - Represents the input of an <code>UpdateItem</code> operation.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - Represents the input of an <code>UpdateTable</code> operation.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
...
#### Parameters
* body (object) **required** - Represents the input of an <code>UpdateTimeToLive</code> operation.
* Action (string) **required**
* Version (string) **required**
* X-Amz-Content-Sha256 (string)
* X-Amz-Date (string)
