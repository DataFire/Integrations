...
```bash
npm install --save datafire @datafire/pandorabots
```
...
* botname (string) **required** - The name of the bot. Format required is 3-64 characters in length and only numbers or lower-case letters [0-9][a-z]
* input (string) **required** - Message to be sent to the bot. This can contain multiple sentences. Currently the limit is 500 characters.
...
#### Parameters
* app_id (string) **required** - Your Application ID
* botname (string) **required** - Name of the bot to delete.
...
#### Parameters
* app_id (string) **required** - Your Application ID
* botname (string) **required** - Must be unique from all the other bots you have created under this app_id. Can only be numbers and lowercase letters, and must be between 3 and 64 characters long.
...
#### Parameters
* app_id (string) **required** - Your Application ID
* botname (string) **required** - Your bot's name
...
#### Parameters
* app_id (string) **required** - Your Application ID
* botname (string) **required** - Name of the bot.
* file-kind (string) **required** - Specify the type of file being deleted: pdefaults, properties
...
* app_id (string) **required** - Your Application ID
* botname (string) **required** - Name of the bot.
* file-kind (string) **required** - Specify the type of file being retrieved: pdefaults, properties
...
* app_id (string) **required** - Your Application ID
* botname (string) **required** - Your bot's name
* file-kind (string) **required** - Specify the type of file being uploaded: pdefaults, properties
...
* app_id (string) **required** - Your Application ID
* botname (string) **required** - Name of the bot.
* file-kind (string) **required** - Specify the type of file being deleted: file (for AIML files), map, substitution, set
* filename (string) **required** - Filename to delete. Note: for non-AIML files, do not include the file extension in the path.
...
* app_id (string) **required** - Your Application ID
* botname (string) **required** - Name of the bot.
* file-kind (string) **required** - Specify the type of file being retrieved: file (for AIML files), map, substitution, set
* filename (string) **required** - Filename to retrieve. Note: for non-AIML files, do not include the file extension in the path.
...
* app_id (string) **required** - Your Application ID
* botname (string) **required** - Your bot's name
* file-kind (string) **required** - Specify the type of file being uploaded: file (for AIML files), map, substitution, set
* filename (string) **required** - Filename to upload, must be named with only lowercase letters and numbers. Note: for non-AIML files, do not include the file extension in the path.
* content (string) **required**
