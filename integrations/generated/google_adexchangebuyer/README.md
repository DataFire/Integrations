...
```json
{
  "$ref": "#/definitions/BillingInfoList"
}
```
## Operation: billingInfo.get
...
```json
{
  "$ref": "#/definitions/CreativeDealIds"
}
```
## Operation: creatives.removeDeal
...
{}
```
## Operation: performanceReport.list
...
```
## Operation: pretargetingConfig.list
...
```json
{
  "$ref": "#/definitions/PretargetingConfigList"
}
```
## Operation: pretargetingConfig.insert
...
```json
{
  ...
  "properties": {
    ...
    "body": {
      "$ref": "#/definitions/PretargetingConfig"
    },
    "alt": {
      "type": "string",
      "description": "Data format for the response.",
...
```
## Operation: pretargetingConfig.delete
...
{}
```
## Operation: pretargetingConfig.get
...
```
## Operation: pretargetingConfig.patch
...
```
## Operation: pretargetingConfig.update
...
```
## Operation: marketplaceprivateauction.updateproposal
...
```json
{
  ...
  "properties": {
    ...
    "body": {
      "$ref": "#/definitions/UpdatePrivateAuctionProposalRequest"
    },
    "alt": {
      "type": "string",
      "description": "Data format for the response.",
...
```
## Operation: marketplacedeals.list
...
```json
{
  "$ref": "#/definitions/GetOrderDealsResponse"
}
```
## Operation: marketplacedeals.delete
...
```json
{
  ...
  "properties": {
    ...
    "body": {
      "$ref": "#/definitions/DeleteOrderDealsRequest"
    },
    "alt": {
      "type": "string",
      "description": "Data format for the response.",
...
```json
{
  "$ref": "#/definitions/DeleteOrderDealsResponse"
}
```
## Operation: marketplacedeals.insert
...
```json
{
  ...
  "properties": {
    ...
    "body": {
      "$ref": "#/definitions/AddOrderDealsRequest"
    },
    "alt": {
      "type": "string",
      "description": "Data format for the response.",
...
```json
{
  "$ref": "#/definitions/AddOrderDealsResponse"
}
```
## Operation: marketplacedeals.update
...
```json
{
  ...
  "properties": {
    ...
    "body": {
      "$ref": "#/definitions/EditAllOrderDealsRequest"
    },
    "alt": {
      "type": "string",
      "description": "Data format for the response.",
...
```json
{
  "$ref": "#/definitions/EditAllOrderDealsResponse"
}
```
## Operation: marketplacenotes.list
...
```json
{
  "$ref": "#/definitions/GetOrderNotesResponse"
}
```
## Operation: marketplacenotes.insert
...
```json
{
  ...
  "properties": {
    ...
    "body": {
      "$ref": "#/definitions/AddOrderNotesRequest"
    },
    "alt": {
      "type": "string",
      "description": "Data format for the response.",
...
```json
{
  "$ref": "#/definitions/AddOrderNotesResponse"
}
```
## Operation: proposals.setupcomplete
...
```json
{
  "$ref": "#/definitions/GetPublisherProfilesByAccountIdResponse"
}
```
