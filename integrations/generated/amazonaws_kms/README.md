...
let amazonaws_kms = require('@datafire/amazonaws_kms').actions;
...
let context = new datafire.Context({
  accounts: {
    amazonaws_kms: account,
  }
})

amazonaws_kms.CancelKeyDeletion({}, context).then(data => {
  console.log(data);
})
```
