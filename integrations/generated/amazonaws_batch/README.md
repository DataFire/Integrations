...
```js
amazonaws_batch.DescribeComputeEnvironments({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_batch.DescribeJobDefinitions({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
```js
amazonaws_batch.DescribeJobQueues({
  "body": {},
  "Action": "",
  "Version": ""
}, context)
...
### ListJobs
Returns a list of task jobs for a specified job queue. You can filter the results by job status with the <code>jobStatus</code> parameter.
