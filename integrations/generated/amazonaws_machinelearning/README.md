...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/CreateBatchPredictionInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/CreateBatchPredictionOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/CreateDataSourceFromRDSInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/CreateDataSourceFromRDSOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/CreateDataSourceFromRedshiftInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/CreateDataSourceFromRedshiftOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/CreateDataSourceFromS3Input"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/CreateDataSourceFromS3Output"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/CreateEvaluationInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/CreateEvaluationOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/CreateMLModelInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/CreateMLModelOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/CreateRealtimeEndpointInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/CreateRealtimeEndpointOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/DeleteBatchPredictionInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/DeleteBatchPredictionOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/DeleteDataSourceInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/DeleteDataSourceOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/DeleteEvaluationInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/DeleteEvaluationOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/DeleteMLModelInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/DeleteMLModelOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/DeleteRealtimeEndpointInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/DeleteRealtimeEndpointOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/DescribeBatchPredictionsInput"
    },
    "Limit": {
      "type": "string",
...
```json
{
  "$ref": "#/definitions/DescribeBatchPredictionsOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/DescribeDataSourcesInput"
    },
    "Limit": {
      "type": "string",
      "description": "Pagination limit"
...
```json
{
  "$ref": "#/definitions/DescribeDataSourcesOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/DescribeEvaluationsInput"
    },
    "Limit": {
      "type": "string",
      "description": "Pagination limit"
...
```json
{
  "$ref": "#/definitions/DescribeEvaluationsOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/DescribeMLModelsInput"
    },
    "Limit": {
      "type": "string",
      "description": "Pagination limit"
...
```json
{
  "$ref": "#/definitions/DescribeMLModelsOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/GetBatchPredictionInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/GetBatchPredictionOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/GetDataSourceInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/GetDataSourceOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/GetEvaluationInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/GetEvaluationOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/GetMLModelInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/GetMLModelOutput"
}
```
## Operation: Predict
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/UpdateBatchPredictionInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/UpdateBatchPredictionOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/UpdateDataSourceInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/UpdateDataSourceOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/UpdateEvaluationInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/UpdateEvaluationOutput"
}
```
...
```json
{
  ...
  "properties": {
    "body": {
      "$ref": "#/definitions/UpdateMLModelInput"
    },
    "Action": {
      "type": "string"
    },
...
```json
{
  "$ref": "#/definitions/UpdateMLModelOutput"
}
```
